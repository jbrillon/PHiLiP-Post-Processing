...
fig_dir_input="/Users/Julien/PHiLiP-Post-Processing/cases/taylor_green_vortex/figures"
# =====================================================
batch_paths = [ \
...
batch_labels = [ \
"$c_{DG}$ NSFR coll.", \
# "$c_{DG}$ NSFR uncoll. [OLD]", \
"$c_{DG}$ NSFR uncoll. [NEW]", \
]
batch_plot_spectra(96,"cDG_uncollocated",batch_paths,batch_labels,title_off=title_off_input,figure_directory=fig_dir_input)
exit()
# =====================================================
batch_paths = [ \
...
"/Users/Julien/NarvalFiles/2023_AIAA/2022-11-29_TGV_SPECTRA_96dofs/viscous_TGV_LES_smagorinsky_cDG_IR_two_point_flux_dofs096_p5_procs512_min_filter_width/", \
]
batch_labels = [ \
"$c_{DG}$ NSFR", \
