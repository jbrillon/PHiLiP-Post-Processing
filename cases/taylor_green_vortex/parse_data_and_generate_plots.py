...
#=====================================================
# DOFs: 96^3 | NSFR-cDG-GL and NSFR-cDG-GLL (BASELINE)
#-----------------------------------------------------
if(True):
    reinit_inputs()
...
#=====================================================
# DOFs: 96^3 | NSFR-cDG (GL and GLL) WITH OVERINTEGRATION
#-----------------------------------------------------
if(True):
    reinit_inputs()
    data_directory_base="/Users/Julien/NarvalFiles/2023_JCP/"
...
if(True):
    ...
    # "$c_{DG}$ NSFR-WALE", \
    # "$c_{DG}$ NSFR-Vreman", \
    # "$c_{DG}$ NSFR-Smag. $C_{S}=0.1$, $\\Delta_{min}$", \
    # ]
    reinit_inputs()
    data_directory_base="/Users/Julien/NarvalFiles/2023_JCP/"
    date_for_runs="."
    ...
    filenames.append("turbulent_quantities.txt")
    labels.append("$c_{DG}$ NSFR-GLL-Vreman $C_{V}=0.081$")
    black_line_flag.append(False)
    dashed_line_flag.append(False)
    #-----------------------------------------------------
    plot_periodic_turbulence(
...
if(True):
    ...
    filenames.append("turbulent_quantities.txt")
    labels.append("$c_{DG}$ NSFR-GLL-LxF")
    black_line_flag.append(False)
    dashed_line_flag.append(False)
    #-----------------------------------------------------
    ...
    filenames.append("turbulent_quantities.txt")
    labels.append("$c_{DG}$ NSFR-GLL-Roe")
    black_line_flag.append(False)
    dashed_line_flag.append(False)
    #-----------------------------------------------------
    ...
    filenames.append("turbulent_quantities.txt")
    labels.append("$c_{DG}$ NSFR-GLL-L2R")
    black_line_flag.append(False)
    dashed_line_flag.append(False)
    #-----------------------------------------------------
    plot_periodic_turbulence(
