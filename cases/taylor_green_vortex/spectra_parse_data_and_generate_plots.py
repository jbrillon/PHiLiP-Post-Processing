...
batch_plot_spectra(96,"flux_nodes",batch_paths,batch_labels,title_off=title_off_input,figure_directory=fig_dir_input)
# =====================================================
batch_paths = [ \
"/Users/Julien/NarvalFiles/2023_JCP/flux_nodes/viscous_TGV_ILES_NSFR_cDG_IR_2PF_GLL_OI-0_dofs096_p5_procs512/", \
...
batch_labels = [ \
"$c_{DG}$ NSFR-GLL", \
"$c_{DG}$ NSFR-GLL-Smag. $C_{S}=0.10$", \
"$c_{DG}$ NSFR-GLL-Smag. $C_{S}=0.18$", \
"$c_{DG}$ NSFR-GLL-WALE $C_{W}=0.50$", \
"$c_{DG}$ NSFR-GLL-Vreman $C_{V}=0.081$", \
]
...
batch_labels = [ \
"$c_{DG}$ NSFR-GL", \
"$c_{DG}$ NSFR-GL-Smag. $C_{S}=0.10$", \
"$c_{DG}$ NSFR-GL-Smag. $C_{S}=0.18$", \
"$c_{DG}$ NSFR-GL-WALE $C_{W}=0.50$", \
"$c_{DG}$ NSFR-GL-Vreman $C_{V}=0.081$", \
]
batch_plot_spectra(96,"sgs_models_gl",batch_paths,batch_labels,title_off=title_off_input,figure_directory=fig_dir_input)
# =====================================================
batch_paths = [ \
"/Users/Julien/NarvalFiles/2023_JCP/flux_nodes/viscous_TGV_ILES_NSFR_cDG_IR_2PF_GL_OI-0_dofs096_p5_procs512/", \
