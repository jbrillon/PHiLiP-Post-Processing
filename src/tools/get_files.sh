...
rsync -zarvm --progress --include="*/" --include="*.txt" --exclude="*" "brillon@narval.computecanada.ca:${narval_directory}" "${target_directory}"
rsync -zarvm --progress --include="*/" --include="*.dat" --exclude="*" "brillon@narval.computecanada.ca:${narval_directory}" "${target_directory}"
